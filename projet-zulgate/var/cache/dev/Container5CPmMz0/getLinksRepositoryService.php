...
// Returns the private 'App\Repository\LinksRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LinksRepository.php';

return $this->privates['App\Repository\LinksRepository'] = new \App\Repository\LinksRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
