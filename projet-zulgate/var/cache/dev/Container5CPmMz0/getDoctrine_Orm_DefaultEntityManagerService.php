...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\LinksRepository' => function () {
    return ($this->privates['App\Repository\LinksRepository'] ?? $this->load('getLinksRepositoryService.php'));
}))));
